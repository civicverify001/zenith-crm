              ...
              {expanded === po.id && (
                <div style={{ padding: '16px 18px', borderTop: '1px solid #1e3a4f' }}>
                  ...
                  <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                    ...
                    {(po.status === 'submitted' || po.status === 'partial') && <span title="Use the Receiving tab to receive this PO and update inventory" style={{ padding: '7px 16px', borderRadius: 8, border: '1px solid rgba(74,222,128,0.15)', background: 'rgba(74,222,128,0.04)', color: '#4ade8066', fontSize: 13, fontWeight: 600, cursor: 'not-allowed', display: 'inline-flex', alignItems: 'center', gap: 6 }}>✅ Use Receiving Tab to receive stock</span>}
